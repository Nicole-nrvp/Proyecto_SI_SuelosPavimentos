                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form class="formulario" method="post" action="Usuario" id="register-user-form" novalidate="novalidate">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-info submitBtn">Registrar</button>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="modal<%=i%>" role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel">Actualizar: <%=usuVO.getUsuNombre()%></h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                ...
                                                <form method="POST" action="Usuario" id="delete">    
                                                    <div class="frm-g-input">
                                                        <input type="hidden" placeholder="Nombre"  name="textId" value="<%=usuVO.getUsuId()%>">
                                                        <input type="hidden" placeholder="Nombre"  name="txtFunId" value="<%=usuVO.getUsuPassword()%>">
                                                        <input type="hidden" id="opcion" name="opcion" value="9">
