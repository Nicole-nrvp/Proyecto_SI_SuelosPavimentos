                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-right">
                                ...
                                <li class="breadcrumb-item active">Tipo de Muestra</li>
                            </ol>
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Registrar Tipo Muestra</h4>
                                ...
                                <!-- end modal-->
                                <h4 class="mt-0 header-title">Tipo Muestra</h4>

                                <p class="sub-title">
                                    el modulo tipo muestra nos da a conocer que muestras se realizan a traves de tipos especificos </p>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <%
                                            TipoMuestraVO tipmueVO = new TipoMuestraVO();
                                            TipoMuestraDAO timueDAO = new TipoMuestraDAO(tipmueVO);
                                            ArrayList<TipoMuestraVO> listaTipoMuestras = timueDAO.listar();
                                            for (int i = 0; i < listaTipoMuestras.size(); i++) {

                                                tipmueVO = listaTipoMuestras.get(i);
                                        %>

                                        <tr>

                                            <td><%=tipmueVO.getTipMueNombre()%></td>
                                            <td><%=tipmueVO.getTipMueEstado()%></td>
                                                ...
                                                <div class="modal fade" id="modal<%=i%>" role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel">Actualizar Tipo Muestra</h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                            ...
                                            <td>
                                                <form method="POST" action="TipoMuestra" id="delete">    
                                                    <div class="frm-g-input">
                                                        <input type="hidden" placeholder="Nombre"  name="textMueId" value="<%=tipmueVO.getTipMueId()%>">
