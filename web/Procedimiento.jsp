...
<%
     if (Rol.equals("SECRETARIA") || Rol.equals("TECNICO")) {
                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Registrar Procedimientos</h4>
                                ...
                                <!-- end modal-->
                                <h4 class="mt-0 header-title">Procedimiento</h4>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="ProcedimientoControlador" id="delete">  
                                                    <div class="frm-g-input">
                                                        <input type="hidden" placeholder="Id"  name="Id" value="<%=elem.getPRO_ID()%>">
                                                        <input type="hidden" placeholder="estado"  name="Estado" value="INACTIVO">
                                                        <input type="hidden" id="opciones" name="opciones" value="4">
