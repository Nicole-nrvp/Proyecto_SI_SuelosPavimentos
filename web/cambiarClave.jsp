                        ...
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="Usuario" id="register-form" novalidate="novalidate" > 
                                    <h4 class="mt-0 header-title">Cambiar Clave</h4>
                                    <p class="sub-title">Aqui podemos cambiar nuestra contraseña y/o recuperarla</p>


                            
                            <div class="form-group row">
                                <label for="txtEstado" class="col-sm-2 col-form-label">Contraseña Anterior</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="password" name="txtEstado" value="" >
                                </div>
                            </div>
                            ...
                            <button type="submit" id="boton" class="btn btn-warning">Cambiar Contraseña</button>                                                                                  
                            </form>
                            <%
