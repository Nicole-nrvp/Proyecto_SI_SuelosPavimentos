                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Registrar Solicitudes</h4>
                                ...
                                <!-- end modal-->
                                <h4 class="mt-0 header-title">Solicitud</h4>

                                <p class="sub-title">
                                    el modulo solicitudes es la idea principal de todo un estudio de sueslos 
                                </p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="Solicitud" id="delete">    
                                                    <div class="frm-g-input">
                                                        <input type="hidden" placeholder="Nombre"  name="textSolId" value="<%=solVO.getSolId()%>">
                                                        <input type="hidden" placeholder="estado"  name="textSolEstado" value="INACTIVO">
